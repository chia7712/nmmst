...
public interface MovieBuffer extends BufferMetrics {
  ...
  /**
   * Inserts the specified frame into this queue, waiting if necessary for space
   * to become available.
   *
  ...
  /**
   * Inserts the specified sample into this queue, waiting if necessary for
  ...
  /**
   * @return {@code true} if this queue has be paused or {@code false} otherwise
   */
  boolean isPause();

  /**
   * @return {@code true} if this queue had be paused or {@code false} otherwise
   */
  boolean hadPause();

  /**
   * Removes all of the frames and samples from this collection The collection
