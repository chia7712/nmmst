...
public class PanelController implements RegisterUtil.Notifiable {
   ...
   * {@link net.nmmst.utils.RequestUtil.RequestType#START} request if this panel
   * is pressed.
   */
  private final BasePanel startPanel;
  /**
   * This panel will send a {@link net.nmmst.utils.RequestUtil.RequestType#STOP}
   * request if this panel is pressed.
   */
  private final BasePanel stopPanel;
  /**
   * This panel will send a
   * {@link net.nmmst.utils.RequestUtil.RequestType#REBOOT} request if this
   * panel is pressed.
   */
  ...
  /**
   * This panel will send a
   * {@link net.nmmst.utils.RequestUtil.RequestType#FUSION_TEST} request if this
   * panel is pressed.
   */
  private final BasePanel testPanel;
  /**
   * This panel will send a {@link net.nmmst.utils.RequestUtil.RequestType#INIT}
   * request if this panel is pressed.
   */
  private final JButton initButton = new JButton("展演準備");
  /**
   * This panel will send a
   * {@link net.nmmst.utils.RequestUtil.RequestType#SHUTDOWN} request if this
   * panel is pressed.
   */
  private final JButton shurdownButton = new JButton("睡覺");
  /**
   * This panel will send a {@link net.nmmst.utils.RequestUtil.RequestType#WOL}
   * request if this panel is pressed.
   */
  private final JButton wakeupButton = new JButton("起床");
  /**
   * This panel will send a
   * {@link net.nmmst.utils.RequestUtil.RequestType#PARTY_1} request if this
   * panel is pressed.
   */
  private final JButton party1Button = new JButton("宴會一");
  /**
   * This panel will send a
   * {@link net.nmmst.utils.RequestUtil.RequestType#PARTY_2} request if this
   * panel is pressed.
   */
  private final JButton party2Button = new JButton("宴會二");
  /**
   * This panel will send a
   * {@link net.nmmst.utils.RequestUtil.RequestType#LIGHT_OFF} request if this
   * panel is pressed.
   */
