...
import codes.chia7712.nmmst.NodeInformation.Location;
...
public class NProperties {
   ...
   * {@link NodeInformation}, and {@link #MOVIE_SELECT} to <code>string</code>
   */
  ...
  /**
   * The selected movie indexes. In default, the number of selected index is
   * two.
   */
  ...
  /**
   * Initializes a newly created NProperties object so that it represents the
  ...
  /**
   * Initializes a newly created NProperties object so that it loads the
   * properties from the local file.
   *
  ...
  /**
   * Returns a string list to which the specified key is mapped, or
   * RuntimeException if this properties contains no mapping for the key.
   *
   * @param key The key whose associated value is to be returned
   * @return A string list to which the specified key is mapped, or
   * RuntimeException if this properties contains no mapping for the key.
   */
  ...
  /**
   * Returns a boolean value to which the specified key is mapped, or
   * RuntimeException if this properties contains no mapping for the key.
   *
   * @param key The key whose associated value is to be returned
   * @return A boolean value to which the specified key is mapped, or
   * RuntimeException if this properties contains no mapping for the key.
   */
  ...
  /**
   * Returns a double value to which the specified key is mapped, or
   * RuntimeException if this properties contains no mapping for the key.
   *
   * @param key The key whose associated value is to be returned
   * @return A double value to which the specified key is mapped, or
   * RuntimeException if this properties contains no mapping for the key.
   */
  ...
  /**
   * Returns a long value to which the specified key is mapped, or
   * RuntimeException if this properties contains no mapping for the key.
   *
   * @param key The key whose associated value is to be returned
   * @return A long value to which the specified key is mapped, or
   * RuntimeException if this properties contains no mapping for the key.
   */
  ...
  /**
   * Returns a integer list to which the specified key is mapped, or
   * RuntimeException if this properties contains no mapping for the key.
   *
   * @param key The key whose associated value is to be returned
   * @return A integer list to which the specified key is mapped, or
   * RuntimeException if this properties contains no mapping for the key.
   */
  ...
  /**
   * Returns a int value to which the specified key is mapped, or
   * RuntimeException if this properties contains no mapping for the key.
   *
   * @param key The key whose associated value is to be returned
   * @return A int value to which the specified key is mapped, or
   * RuntimeException if this properties contains no mapping for the key.
   */
  ...
  /**
   * Returns a string to which the specified key is mapped, or RuntimeException
   * if this properties contains no mapping for the key.
   *
   * @param key The key whose associated value is to be returned
   * @return A string to which the specified key is mapped, or RuntimeException
   * if this properties contains no mapping for the key.
   */
  ...
  /**
   * Converts a {@code String} to a map of selectable movie index and selected
   * movie index.
   *
