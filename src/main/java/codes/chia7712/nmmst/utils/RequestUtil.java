...
import codes.chia7712.nmmst.threads.Taskable;

/**
 * Utility medhods provide the queue for receiving the request from remote
 * nodes.
 */
public final class RequestUtil {
  ...
  /**
   * Enumerates the request type for commanding node to do something.
   */
  ...
  /**
   * Sets the background in the fusion green. Does we should set the limit of
   * image number??
   */
  public static class SetImageRequest extends Request {
    ...
    /**
     * @return The image
     * @throws IOException If failed to convert bytes array to image
     */
  ...
  /**
   * Encapsulates the {@link codes.chia7712.nmmst.processor.LinearProcessor.Factor} and
