...
import codes.chia7712.nmmst.processor.LinearProcessor;
import codes.chia7712.nmmst.processor.LinearProcessor.Factor;
import codes.chia7712.nmmst.utils.Painter;
import codes.chia7712.nmmst.utils.RequestUtil.FusionTestRequest;
...
public class FusionTuner extends JFrame implements WindowListener {
  ...
  private static final BufferedImage NO_NODE_IMAGE
          = Painter.getStringImage("No node",
                  ...
                  30);
  /**
   * Queues the {@link codes.chia7712.nmmst.utils.RequestUtil.FusionTestRequest}. It is
   * shared between node panels.
   */
  private final BlockingQueue<Pair<NodeInformation, Factor>> queue
          = new LinkedBlockingQueue();
  /**
   * A thread for sending the
   * {@link codes.chia7712.nmmst.utils.RequestUtil.FusionTestRequest}.
   */
  ...
  /**
   * A node panel provides many fields to write the {@link NodeInformation} and
   * {@link Factor}.
   */
  private static class NodePanel extends JPanel {
    ...
    /**
     * Queues the {@link codes.chia7712.nmmst.utils.RequestUtil.FusionTestRequest}.
     */
    private final BlockingQueue<Pair<NodeInformation, Factor>> queue;
     ...
     */
    NodePanel(final BlockingQueue<Pair<NodeInformation, Factor>> requestQueue, final NodeInformation nodeInfo) {
      queue = requestQueue;
      addressText.setText(
