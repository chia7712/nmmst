...
/**
 * instantiates the {@link FrameProcessor} which only overrides the
 * {@link FrameProcessor#postDecodeFrame(codes.chia7712.nmmst.media.Frame)}.
 */
public final class ProcessorFactory {
  ...
  /**
   * Instantiates the FrameProcessor with specified node location and factor.
   *
  ...
  /**
   * Instantiates the FrameProcessor with specified node location and default
   * fusion factor.
   *
   * @param location The node locaction
   * @return A frame processor
